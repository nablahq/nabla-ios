...
extension UIViewController {
     ...
     */
    public func addPullUpController(_ pullUpController: PullUpController,
     ...
     */
    public func removePullUpController(_ pullUpController: PullUpController,
                                     animated: Bool, 
                                     completion: ((Bool) -> Void)? = nil) {
...
extension UIScrollView {
     ...
     */
    public func attach(to pullUpController: PullUpController) {
     ...
     */
    public func detach(from pullUpController: PullUpController) {
