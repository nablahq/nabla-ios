//
//  MeasurementSystemController.swift
...
class MeasurementSystemController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.navigationItem.title = "Measurement System"
    ...
    @objc private func radioGroupSelected(_ sender: ALRadioGroup) {
        ...
        {
//            Settings.shared.isMetricMeasurementSystem = true
            UserDefaults.standard.set(true, forKey: "is_metric_measurement_system")

        }
        else
        {
//            Settings.shared.isMetricMeasurementSystem = false
            UserDefaults.standard.set(false, forKey: "is_metric_measurement_system")
        }
